            ...
            >
              <div className="w-[100%] md:w-[50%]">
                ...
                <div>
                  ...
                  <li>
                    monitory i tablice interaktywne w każdej sali przedszkolnej
                  </li>
              ...
              <div className="w-[100%] md:w-[50%] mt-10 md:mt-0">
                <h4>
                  Przedszkole Planeta Dziecka zlokalizowane jest w przestronnym,
                  dobrze oświetlonym budynku, spełniającym wszystkie standardy
                  bezpieczeństwa i higieny przedszkolnej. Dbamy o bezpieczeństwo
                  dzieci, stosując certyfikowane materiały do wykończenia sal,
                  dostosowane do konkretnych przedziałów wiekowych. Wyposażone w
                  pełni sale, przyjazna kolorystyka wnętrz oraz duże ilości
                  światła tworzą atmosferę ciepła i przestrzeni. Dodatkowo,
                  posiadamy funkcjonalny plac zabaw z urządzeniami spełniającymi
                  ważne funkcje w rozwoju poznawczym i motorycznym dzieci.
                </h4>
              </div>
            </div>
