    ...
    <section className="bg-purple pt-[44px]">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="pl-[0px] xxs:pl-[10px] xs:pl-[20px] sm:pl-[50px] md:pl-[0px] border-orange border-t-[8px] border-l-[8px] rounded-tl-[20px]">
            ...
            <div className=" p-[20px] md:p-[36px] pr-[20px] md:pr-[76px]">
              ...
              <h4 className={`${styles.n20} text-white mb-10`}>
                ...
                lat, które odbywają się w jedną, wybraną sobotę w miesiącu w
                godz. 10:00 – 12:00 w okresie maja i czerwca danego roku
                szkolnego.
              </h4>
              <h4 className={`${styles.n20} text-white mb-10`}>
                Podczas zajęć maluchy wspólnie z rodzicami pracują ciekawymi
                technikami plastycznymi. Biorą udział w zabawach, które czasem
                nie są możliwe do zorganizowania w domu: wspólne zabawy w kole,
                zabawy z chustą animacyjną, ziarnami lub wodą.
              </h4>
              <h4 className={`${styles.n20} text-white mb-10`}>
                PLANETA MALUSZKA to także źródło pomysłów na zabawy do
                wykorzystania w domu. Dzieci nauczą się nowych zabaw
                paluszkowych, ruchowych, muzycznych. Będą tworzyć prace
                plastyczne różnymi, ciekawymi technikami a stworzone „dzieła”
                zabiorą ze sobą do domu. Przyjazną atmosferę tworzą uśmiechnięte
                i otwarte Ciocie, które zawsze służą poradą w sprawach
              ...
              <h4 className={`${styles.n20} text-white  mb-16`}>
                ...
                zajęciom w PLANECIE MALUSZKA dziecko łatwiej rozstanie się z
                mamą i tatą wtedy, gdy nadejdzie czas pójścia do przedszkola.
                WAŻNE: Rodzice/opiekunowie dzieci biorą czynny udział w
                sobotnich zajęciach. Zalecamy wygodny, swobodny strój.
              </h4>
              <h3 className={`${styles.n40} text-white mb-[51px]`}>
