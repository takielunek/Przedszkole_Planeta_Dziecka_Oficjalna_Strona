...
const Adaptation = () => {
  return (
    <section className="bg-purple pt-[44px] relative">
      <div className="flex flex-row">
        <div className="p-[24px] pl-[40px] sm:pl-[72px] pt-[100px]">
          ...
          <h4 className={`${styles.n20} text-white mb-6`}>
            Każdemu rodzicowi zależy na tym, by dziecko czuło się w przedszkolu
            dobrze, bezpiecznie i komfortowo. Oddając własną pociechę na większą
            część dnia pod opiekę wykwalifikowanych, ale jednak obcych nam i
            maluchowi osób, mamy często poczucie dyskomfortu i wyrzuty sumienia.
            W pewnym sensie rodzic może mieć poczucie, że oddala się od własnego
            dziecka, opuszcza je.
          </h4>
          <h4 className={`${styles.n20} text-white`}>
            Nic bardziej mylnego! Jeżeli postaramy się, żeby dziecko rozpoczęło
            edukację przedszkolną dobrze do niej psychicznie i emocjonalnie
            nastawione, okaże się, że wspomnienia z przedszkola będą dla niego
            pozytywnym bagażem uczuciowym na całe życie.
          </h4>
          <img src={img13} alt="Dzieci w przedszkolu" className="absolute w-[50.8%] bottom-0 left-0" />
        </div>

        <div className="border-orange border-t-[8px] border-l-[8px] rounded-tl-[20px]">
          <div className="p-[36px] pr-[76px]">
