...
const Footer = () => {
  return (
    <section className="bg-orange px-[40px] sm:px-[72px] pt-[16px]">
      <div className="flex flex-row justify-between">
        ...
        <div className="flex flex-row justify-between w-[191px] pt-[13px]">
          ...
          <a href="mailto:suchedniow@planeta-dziecka.pl">
            <img src={email} alt="email icon" className="w-[36px] h-[36px]" />
          </a>
          <a href="tel:501 806 012">
            <img src={phone} alt="phone icon" className="w-[36px] h-[36px]" />
          </a>
        </div>
      </div>
