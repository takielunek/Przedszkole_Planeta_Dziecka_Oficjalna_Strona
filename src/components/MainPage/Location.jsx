...
const Location = () => {
  return (
    <section className="bg-cream relative">
      ...
      <div>
        <iframe className="w-[100%] h-[550px]" src="https://www.google.com/maps/embed/v1/place?q=Sportowa+1A,+26-130+Suchedniów,+Poland&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
      </div>
      <div>
      ...
      <div className="flex justify-center">
        <button
          className={`${styles.button2} ${styles.s20} text-white mt-[273px] mb-[51px]`}
        >
          Zapisz dziecko
        </button>
      </div>
